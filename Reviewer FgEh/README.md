...
2. Human feedback to learn a reward, as discussed in Section 2.3.3 for one of the experiments. 
...
We would like to reiterate that human feedback for learning rewards is only needed when the measurements are extremely abstract and we only needed that for one of our experiments (which was also subsequently replaced with CLIP-based AI feedback). 
